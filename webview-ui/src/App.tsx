...
import { ProjectLegend } from './components/ProjectLegend.js'
import { ProjectZones } from './components/ProjectZones.js'
...
function App() {
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
      ...
      <ProjectLegend officeState={officeState} agents={agents} />
