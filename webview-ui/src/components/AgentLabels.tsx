          ...
          >
            ...
            <span
              style={{
                ...
                color: '#fff',
                // Tint the label with the agent's AgentsRoom project color so
                // same-project agents read as a group at a glance.
                background: ch.projectColor ? `${ch.projectColor}E6` : 'rgba(30,30,46,0.7)',
